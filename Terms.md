...
> スコマド内に、運営会社または他社の広告を表示することがあります。
...
> 広報やサービス改善に必要な範囲で、投稿していただいたコンテンツを運営会社または委託する企業に使用させていただくことがあります。(一部編集する可能性があります。)また、この際情報の省略を行う場合があります。
...
> 14条に定める通り、トトラブルに関して運営会社が取引解除の介入をした場合、返金対応を行います。  
